...
class MapViewController: UIViewController {
    ...
    let addToContactButton : UIButton = {
        let b = UIButton()
        b.setTitle("contact", for: .normal)
        b.backgroundColor = UIColor(white: 1, alpha: 0)
        b.setImage(UIImage(named: "addToFav"), for: .normal)
        b.translatesAutoresizingMaskIntoConstraints = false
        b.addTarget(self, action: #selector(addToContactTapped), for: .touchUpInside)
        return b
    }()
    ...
    func setupViews(){
        ...
        self.videoView.addSubview(addToContactButton)
        ...
        NSLayoutConstraint.activate([
            ...
            addToContactButton.topAnchor.constraint(equalTo: self.videoView.topAnchor, constant: 5),
            addToContactButton.trailingAnchor.constraint(equalTo: self.videoView.trailingAnchor, constant: -5),
            addToContactButton.widthAnchor.constraint(equalToConstant: 30),
            addToContactButton.heightAnchor.constraint(equalToConstant: 30)
            ])
    }
    ...
    @objc func addToContactTapped(){
        
    }
    
    @objc func removeFromContact(){
